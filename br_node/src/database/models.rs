...
use brl::std_lib::integer_extended::IntegerExtended;
...
impl From<&brl::block::header::Header> for NewHeader {
    fn from(header: &brl::block::header::Header) -> Self {
...
mod models_tests {
    use super::*;
    use brl::{block::header::Header, std_lib::integer_extended::IntegerExtended};
