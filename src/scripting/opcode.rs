...
pub static OP_TO_FN: Lazy<[OpCodeInfo; OPS_LENGTH]> = Lazy::new(|| {
    ...
    op_to_fn[OP_IFDUP] = OpCodeInfo::new("OP_IFDUP", op_ifdup);
    op_to_fn[OP_DEPTH] = OpCodeInfo::new("OP_DEPTH", op_depth);
    ...
    op_to_fn[OP_OVER] = OpCodeInfo::new("OP_OVER", op_over);
    op_to_fn[OP_PICK] = OpCodeInfo::new("OP_PICK", op_pick);
    op_to_fn[OP_ROLL] = OpCodeInfo::new("OP_ROLL", op_roll);
    op_to_fn[OP_ROT] = OpCodeInfo::new("OP_ROT", op_rot);
    op_to_fn[OP_SWAP] = OpCodeInfo::new("OP_SWAP", op_swap);
    op_to_fn[OP_TUCK] = OpCodeInfo::new("OP_TUCK", op_tuck);
    ...
    op_to_fn[OP_SIZE] = OpCodeInfo::new("OP_SIZE", op_size);
    ...
    op_to_fn[OP_1ADD] = OpCodeInfo::new("OP_1ADD", op_1add);
    op_to_fn[OP_1SUB] = OpCodeInfo::new("OP_1SUB", op_1sub);
    op_to_fn[OP_2MUL] = OpCodeInfo::new("OP_2MUL", deprecated);
    op_to_fn[OP_2DIV] = OpCodeInfo::new("OP_2DIV", deprecated);
    op_to_fn[OP_NEGATE] = OpCodeInfo::new("OP_NEGATE", op_negate);
    op_to_fn[OP_ABS] = OpCodeInfo::new("OP_ABS", op_abs);
    op_to_fn[OP_NOT] = OpCodeInfo::new("OP_NOT", op_not);
    op_to_fn[OP_0NOTEQUAL] = OpCodeInfo::new("OP_0NOTEQUAL", op_0notequal);
    op_to_fn[OP_ADD] = OpCodeInfo::new("OP_ADD", op_add);
    op_to_fn[OP_SUB] = OpCodeInfo::new("OP_SUB", op_sub);
    ...
    op_to_fn[OP_BOOLAND] = OpCodeInfo::new("OP_BOOLAND", op_booland);
    op_to_fn[OP_BOOLOR] = OpCodeInfo::new("OP_BOOLOR", op_boolor);
