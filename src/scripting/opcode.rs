...
pub static OP_TO_FN: Lazy<[OpCodeInfo; OPS_LENGTH]> = Lazy::new(|| {
    ...
    op_to_fn[OP_RESERVED] = OpCodeInfo::new("OP_RESERVED", not_implemented);
    ...
    op_to_fn[OP_VER] = OpCodeInfo::new("OP_VER", not_implemented);
    op_to_fn[OP_IF] = OpCodeInfo::new("OP_IF", not_implemented);
    op_to_fn[OP_NOTIF] = OpCodeInfo::new("OP_NOTIF", not_implemented);
    op_to_fn[OP_VERIF] = OpCodeInfo::new("OP_VERIF", not_implemented);
    op_to_fn[OP_VERNOTIF] = OpCodeInfo::new("OP_VERNOTIF", not_implemented);
    op_to_fn[OP_ELSE] = OpCodeInfo::new("OP_ELSE", not_implemented);
    op_to_fn[OP_ENDIF] = OpCodeInfo::new("OP_ENDIF", not_implemented);
    op_to_fn[OP_VERIFY] = OpCodeInfo::new("OP_VERIFY", not_implemented);
    op_to_fn[OP_RETURN] = OpCodeInfo::new("OP_RETURN", not_implemented);
    ...
    op_to_fn[OP_2DUP] = OpCodeInfo::new("OP_2DUP", not_implemented);
    ...
    op_to_fn[OP_EQUAL] = OpCodeInfo::new("OP_EQUAL", not_implemented);
    ...
    op_to_fn[OP_ADD] = OpCodeInfo::new("OP_ADD", not_implemented);
    ...
    op_to_fn[OP_NOP1] = OpCodeInfo::new("OP_NOP1", not_implemented);
    ...
    op_to_fn[OP_NOP4] = OpCodeInfo::new("OP_NOP4", not_implemented);
    op_to_fn[OP_NOP5] = OpCodeInfo::new("OP_NOP5", not_implemented);
    op_to_fn[OP_NOP6] = OpCodeInfo::new("OP_NOP6", not_implemented);
    op_to_fn[OP_NOP7] = OpCodeInfo::new("OP_NOP7", not_implemented);
    op_to_fn[OP_NOP8] = OpCodeInfo::new("OP_NOP8", not_implemented);
    op_to_fn[OP_NOP9] = OpCodeInfo::new("OP_NOP9", not_implemented);
